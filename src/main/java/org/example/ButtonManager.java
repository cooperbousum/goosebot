...
public class ButtonManager extends ListenerAdapter {
    ...
    private static final Button viewCode = Button.link("https://github.com/cooperbousum/goosebot/tree/master", "View goosebot!'s Code");
    ...
    public static Button getViewCode() {
